...
$jobs = [
    [
        'name' => 'Контроллер молока на ферме',
        'date' => 'май 2021 - декабрь 2022',
        'duties' => 'Каждое утро после дегустировал молоко у Буренок и составлял рейтинг',
    ],
    [
        'name' => 'Эпидимиолог на складе',
        'date' => 'январь 2018 - май 2021',
        'duties' => 'Ловил на складе мышей и крыс',
    ],
    [
        'name' => 'Няня ребенка',
        'date' => 'апрель 2015 - декабрь 2018',
        'duties' => 'Был няней и другом Васи',
    ],
    ];
?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobs[$i]['date'];?></h6>
            <p><?php echo $jobs[$i]['duties'];?></p>
            <hr>
          </div>
          <?php endfor;?>
        </div>
